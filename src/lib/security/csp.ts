...
export function buildContentSecurityPolicy(nonce: string, nodeEnv = process.env.NODE_ENV): string {
  ...
  return [
    ...
    "connect-src 'self' wss: https://*.supabase.co wss://*.supabase.co https://api.openai.com https://api.anthropic.com https://graph.facebook.com https://accept.paymob.com https://*.paymob.com https://connect.facebook.net https://www.facebook.com https://web.facebook.com https://accounts.google.com https://oauth2.googleapis.com https://www.googleapis.com https://api.resend.com https://*.sentry.io https://*.ingest.sentry.io https://*.ingest.us.sentry.io https://vercel.live https://*.vercel.live wss://*.pusher.com https://*.pusher.com",
