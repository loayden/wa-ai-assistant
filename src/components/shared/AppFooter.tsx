...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "How setup works", href: "/#setup" },
    ],
  },
  {
    title: "Trust",
    links: [
      { label: "Verified connection", href: "/whatsapp" },
      { label: "Encrypted storage", href: "/#setup" },
      { label: "Owner can pause AI", href: "/dashboard" },
      { label: "Paymob billing", href: "/billing" },
    ],
  },
];

const trustNotes = [
  "Manual WhatsApp setup is guided and verified before saving.",
  "Owners can pause AI replies anytime.",
  "Plans use clear monthly reply limits.",
];
    ...
    <footer className={cn("border-t border-wa-gray-100 bg-white", className)}>
      <div className={cn("mx-auto max-w-[1120px] px-3 sm:px-6", compact ? "py-6 sm:py-8" : "py-8 sm:py-12 lg:py-14")}>
        <div className="grid gap-6 sm:gap-8 lg:grid-cols-[1fr_1.45fr]">
          <div>
            <Link href="/" className="inline-flex items-baseline gap-2 text-xl font-semibold text-wa-gray-900 sm:text-2xl" aria-label="kallem home">
            ...
            <p className="mt-3 max-w-[440px] text-body-sm leading-6 text-wa-gray-600 sm:mt-4">
              A formal AI WhatsApp assistant for small businesses. Connect WhatsApp, automate replies, review messages, and keep billing clear.
            </p>
        ...
        <div className={cn("flex flex-col gap-3 text-body-sm text-wa-gray-500 md:flex-row md:items-center md:justify-between", compact ? "mt-6" : "mt-6")}>
          ...
          <div className="flex flex-wrap gap-2">
            <span className="rounded-full border border-wa-gray-100 bg-white px-3 py-1.5 text-xs font-semibold text-wa-gray-600">50 free replies</span>
            <span className="rounded-full border border-wa-gray-100 bg-white px-3 py-1.5 text-xs font-semibold text-wa-gray-600">Pro EGP 999/mo</span>
            <span className="rounded-full border border-wa-gray-100 bg-white px-3 py-1.5 text-xs font-semibold text-wa-gray-600">Business EGP 2,499/mo</span>
          </div>
        </div>
      </div>
    </footer>
